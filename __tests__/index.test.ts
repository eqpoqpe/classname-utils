...
test("className concat with inheritOrBase", () => {
  ...
  expect(classNameConcat([className, "flex", "min-h-screen", "flex-col", darkClassName, "items-center", "justify-between", "p-24"]))
    .toBe("base flex-col flex min-h-screen flex-col dark:text-pink-500 items-center justify-between p-24");
});